...
//  
//
//  Created by Anatoly Shin on 15.02.2022.
//
...
public class WebRTCClient: NSObject, RTCPeerConnectionDelegate, RTCVideoViewDelegate, RTCDataChannelDelegate {
    ...
    public var peerConnections: [Int32: RTCPeerConnection?] = [:]
    ...
    public var channels: (video: Bool, audio: Bool, datachannel: Bool) = (false, false, false)
    public var customFrameCapturer: Bool = false
    public var cameraDevicePosition: AVCaptureDevice.Position = .front
    
    public var delegate: WebRTCClientDelegate?
    public private(set) var isConnected: Bool = false
    
    public func localVideoView() -> (RTCVideoTrack?, RTCAudioTrack?) {
        return (localVideoTrack, localAudioTrack)
    }
    
    public func remoteVideoView() -> RTCMediaStream? {
...
//        remoteRenderView?.frame = remoteView.frame
    ...
    public func receiveAnswer(index: Int32, answerSDP: RTCSessionDescription) {
//        if index >= peerConnections.count {
//            return
//        }
    ...
    public func receiveCandidate(index: Int32, candidate: RTCIceCandidate) {
...
//        }
    ...
    private func setupPeerConnection() -> RTCPeerConnection? {
        ...
        let iceServers = self.iceServers
